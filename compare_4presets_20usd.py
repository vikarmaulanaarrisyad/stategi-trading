...
def run_preset_20usd(rates_clean, preset_name="1YEAR_OPTIMAL"):
    ...
    return {
        ...
        'final_balance': balance, 'min_balance': min_balance, 'min_equity': min_equity,
...
def main():
    ...
    presets = ["1YEAR_OPTIMAL", "FAST", "SNIPER", "SCALPING"]
    print("=========================================================================================================================")
    print("HASIL BACKTEST 4 PRESET QUICKPRO MT4: MODAL $20.00 | FIXED LOT 0.01 (JANUARI - SEPTEMBER 2026)")
    print("=========================================================================================================================")
    print(f"{'Nama Preset':<25} | {'Trades':<7} | {'Win Rate':<9} | {'PF':<5} | {'Saldo Akhir':<12} | {'Net Profit ($)':<14} | {'Pertumbuhan':<11} | {'Min Balance'}")
    print("-" * 120)

    for p in presets:
        r = run_preset_20usd(rates_clean, p)
